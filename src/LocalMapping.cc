					...
					if (mpAtlas->KeyFramesInMap() > 2)
					{
						...
						else
						{
							if (!mbUseMS) Optimizer::LocalBundleAdjustment(mpCurrentKeyFrame, &mbAbortBA, mpCurrentKeyFrame->GetMap(), num_FixedKF_BA, num_OptKF_BA, num_MPs_BA, num_edges_BA);
								...
								RuntimeProfile::WsbaScope wsba;
#endif
								Optimizer::MatteSpotLocalBundleAdjustment(mpCurrentKeyFrame, &mbAbortBA, mpCurrentKeyFrame->GetMap(), num_FixedKF_BA, num_OptKF_BA, num_MPs_BA, num_edges_BA);
							}
							b_doneLBA = true;
